...
class ChapterdzRules extends StatefulWidget {
  final Rules_Dzongkha sact;
  const ChapterdzRules({
    Key? key,
    required this.sact,
  }) : super(key: key);

  @override
  _ChapterdzRulesState createState() => _ChapterdzRulesState();
}

class _ChapterdzRulesState extends State<ChapterdzRules> {
  String name = "";
