...
import 'package:lgapplication/api/actdzo_api.dart';
import 'package:lgapplication/model/act_dzo.dart';
import 'package:lgapplication/pages/detail_dz_act.dart';
            ...
            child: SafeArea(
              child: CustomScrollView(
                slivers: <Widget>[
                  ...
                  SliverFillRemaining(
                      child: Container(
                    child: FutureBuilder<List<Acts_Dzongkha>>(
                      future: ActsdzoApi.getActsdLocali(context),
                      builder: (context, snapshot) {
                        final actd = snapshot.data;
                            ...
                            if (snapshot.hasError) {
                              ...
                              return Column(
                                ...
                                children: [
                                  ...
                                  Expanded(child: buildDzoact(actd!)),
                                ],
                              );
                            }
                        }
...
Widget buildDzoact(List<Acts_Dzongkha> actd) => ListView.builder(
      // ignore: prefer_const_constructors
      physics: BouncingScrollPhysics(),
      itemCount: actd.length,
      itemBuilder: (context, index) {
        final dact = actd[index];
        return InkWell(
          onTap: () => Navigator.of(context).push(PageTransition(
            type: PageTransitionType.bottomToTop,
            child: ChapterdzAct(dact: dact),
          )),
          child: Padding(
